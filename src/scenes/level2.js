...
export default class Level2 extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('exitLev2', 'src/assets/common/home.png')
    ...
    create() {
        ...
        var bg = this.add
            .sprite(innerWidth / 2, innerHeight / 2, 'bg_l2')
        ...
        // this.add
        //   .sprite(innerWidth * 0.96, innerHeight * 0.38, 'help_l2')
        //   .setScale(0.09 * stat.koeff, 0.09 * stat.koeff)
        // this.add
        //   .sprite(innerWidth * 0.96, innerHeight * 0.5, 'progress_l2')
        //   .setScale(0.09 * stat.koeff, 0.09 * stat.koeff);
        var rules = this.add
            .sprite(innerWidth * 0.96, innerHeight * 0.5, 'statistics_l2')
            .setScale(0.09 * stat.koeff, 0.09 * stat.koeff)
            .setInteractive();

        var exitLevel = this.add
            .sprite(innerWidth * 0.96, innerHeight * 0.65, 'exitLev2')
            .setScale(0.09 * stat.koeff, 0.09 * stat.koeff)
            .setInteractive();
        // this.add
        //   .sprite(innerWidth * 0.96, innerHeight * 0.74, 'character_l2')
        //   .setScale(0.09 * stat.koeff, 0.09 * stat.koeff);
        this.add
            .sprite(innerWidth * 0.09, innerHeight * 0.08, 'score_l2')
        ...
        var borrow = this.add
            .sprite(innerWidth / 12, innerHeight * 0.58, 'bomb')
            .setScale(0.17 * stat.koeff, 0.17 * stat.koeff)
            .setInteractive();
        var save = this.add
            .sprite(innerWidth / 12 + cell.width, innerHeight * 0.58, 'moneybox')
            .setScale(0.17 * stat.koeff, 0.17 * stat.koeff)
            .setInteractive();
    ...
    update() {
        ...
        // if (this.players_money === 0 && this.active_cell!==null && this.active_cell!==0 ) {
        if (this.players_money === 0 && this.players_borrow > 0 && tmp.description!=='end') {
            ...
            // else if (this.players_money===0 && this.players_borrow===0){
            //     this.scene.launch('Borrow', {par: this.scene});
            //     this.scene.pause();
            // }
    ...
    createWindow(type, description) {
        ...
        if (description === 'end') {
            ...
            if (
                ...
                var comp = this.add
                    .sprite(innerWidth * 0.96, innerHeight * 0.93, 'complete_l2')
